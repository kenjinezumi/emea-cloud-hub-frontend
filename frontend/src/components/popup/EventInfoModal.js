...
export default function EventInfoPopup({ event, close }) {
  ...
  const sections = {
    ...
    'Details': (
      <Stack spacing={2} sx={{ p: 3 }}>
        ...
        <Typography variant="body2" sx={{ marginLeft: '30px', wordBreak: 'break-word', whiteSpace: 'normal' }}>
          {selectedEvent.audience ? selectedEvent.audience.join(', ') : 'N/A'}
        </Typography>
        ...
        <Typography variant="body2" sx={{ marginLeft: '30px', wordBreak: 'break-word', whiteSpace: 'normal' }}>
          {selectedEvent.languages ? selectedEvent.languages.join(', ') : 'N/A'}
        </Typography>
      </Stack>
    ),
    'Links': (
      <Stack spacing={2} sx={{ p: 3 }}>
        ...
        <Typography variant="body2" sx={{ marginLeft: '30px', wordBreak: 'break-word', whiteSpace: 'normal' }}>
          {selectedEvent.additionalResources && selectedEvent.additionalResources.length > 0
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-20" style={{ zIndex: 5000 }}>
      <Draggable handle=".drag-handle" nodeRef={nodeRef}>
        <div ref={nodeRef}> {/* Node ref should be on the draggable container */}
          <Paper
            sx={{
              minWidth: 600,
              maxWidth: 600,
              ...
              {Object.keys(sections).map((section) => (
                <Button
                  ...
                  sx={{
                    ...
                    borderRadius: '20px',
                    backgroundColor: currentSection === section ? 'rgba(52, 103, 210, 0.8)' : 'white',
